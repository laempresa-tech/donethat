    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-xl border-b border-[rgba(11,16,32,0.08)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-5 flex items-center justify-between">
        <motion.div 
          ...
          className="text-[24px] sm:text-[28px] md:text-[32px] lg:text-[36px] font-[920] tracking-[-0.03em] bg-gradient-to-r from-[#4B8FD8] to-[#ffb199] bg-clip-text text-transparent"
        >
          DoneThat
        </motion.div>
        <motion.div
        ...
        >
          <div className="px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-full bg-gradient-to-r from-[#4B8FD8] to-[#ffb199] text-white text-[10px] sm:text-xs md:text-sm font-extrabold">

      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className="bg-gradient-to-br from-[#4B8FD8] to-[#3d7ab8] rounded-[20px] sm:rounded-3xl md:rounded-[28px] p-6 sm:p-8 md:p-10 text-white shadow-[0_26px_80px_rgba(75,143,216,0.3)] hover:shadow-[0_32px_96px_rgba(75,143,216,0.4)] transition-all duration-300"
          >
            <motion.div
              initial={{ scale: 0 }}
              whileInView={{ scale: 1 }}
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
            whileHover={{ y: -5 }}
            className="bg-gradient-to-br from-[#ffb199] to-[#ffcab8] rounded-[20px] sm:rounded-3xl md:rounded-[28px] p-6 sm:p-8 md:p-10 text-white shadow-[0_26px_80px_rgba(255,161,120,0.3)] hover:shadow-[0_32px_96px_rgba(255,161,120,0.4)] transition-all duration-300"
          >
            <motion.div
              initial={{ scale: 0 }}
              whileInView={{ scale: 1 }}
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full bg-gradient-to-r from-[rgba(75,143,216,0.15)] to-[rgba(255,161,120,0.12)] border border-[rgba(11,16,32,0.08)]">
